...
export default function MediaCard({ item }: MediaCardProps) {
  ...
  const creatorHandle = rawUser.startsWith("@") ? rawUser : `@${rawUser}`;
  const avatarInitials = (rawUser.charAt(0) || "M").toUpperCase();
      ...
      >
        ...
        <div className="relative z-10 border-t border-slate-800/60 bg-slate-950/95 px-4 pb-4 pt-3 sm:px-6 sm:pb-5 sm:pt-4">
          ...
          <div className="mt-3 flex items-center justify-between gap-3">
            ...
            {/* Pas de bouton Display pour l’instant :
                toute la carte ouvre la page /p/[id]. */}
          </div>
        </div>
      </article>
    </Link>
