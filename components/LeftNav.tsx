...
import { Home, Users, Camera, Sparkles, DollarSign, Mail, Bell, Shield, Clock } from 'lucide-react';

const items = [
  { href: '/', label: 'Amazing', icon: Home },
  { href: '/meet', label: 'Meet me', icon: Users },
  { href: '/mymagic', label: 'My Magic Clock', icon: Clock },
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-2 rounded-xl px-3 py-2 text-sm transition-colors ${
                active
                  ? 'bg-indigo-50 border border-brand-500 text-brand-600'
                  : 'hover:bg-slate-100'
              }`}
            >
