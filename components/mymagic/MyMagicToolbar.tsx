...
export default function MyMagicToolbar() {
  ...
  return (
    <>
      <div
        className={`sticky top-0 z-40 mb-4 bg-slate-50/80 pb-3 pt-3 backdrop-blur transition-transform duration-300 px-4 sm:mx-0 sm:px-0 sm:bg-transparent ${
      ...
      {/* ✅ Modale suppression — AlertTriangle Lucide, zéro emoji */}
      {showDeleteModal && (
        <div
          ...
          >
            <div className="text-center mb-4">
              ...
              <p className="text-sm text-slate-500 mt-1">
                Cette action est{" "}
                <strong>irréversible</strong>. Toutes tes données seront
            ...
            <button
              ...
              className="mt-3 flex w-full items-center justify-center gap-2 rounded-2xl bg-red-600 py-3 text-sm font-semibold text-white disabled:opacity-30"
            >
              {deleting ? (
                <>
                  <Trash2 className="h-4 w-4 animate-pulse" strokeWidth={1.5} />
                  Suppression...
                </>
              ) : (
                <>
            ...
            <button
              ...
              className="mt-2 flex w-full items-center justify-center gap-2 rounded-2xl bg-slate-100 py-3 text-sm font-medium text-slate-700"
            >
