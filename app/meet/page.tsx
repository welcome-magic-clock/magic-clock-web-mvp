...
const REPEAT_COUNT = 8; // même principe : on répète la liste de créateurs
...
export default function MeetPage() {
  ...
  return (
    <main className="mx-auto max-w-5xl px-4 pb-24 pt-4 sm:px-6 sm:pt-8 sm:pb-28">
      ...
      {/* Liste avec “faux” scroll infini */}
      <section className="flex flex-col gap-6 sm:gap-8 snap-y snap-mandatory">
        {extendedCreators.map((creator: any) => (
          <div
            key={creator._fakeId}
            className="snap-start rounded-[32px] border border-slate-200 bg-white shadow-sm overflow-hidden min-h-[calc(100vh-210px)] sm:min-h-[420px]"
          >
