...
export default function MyMagicClockPage() {
  // On force le type pour être aligné avec MediaCard
  ...
  return (
    <div className="container space-y-8">
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm text-slate-600">
          Pour l&apos;instant, nous réutilisons une sélection de contenus du flux
          Amazing comme aperçu. Plus tard, seuls vos propres Magic Clock
      ...
      <section className="space-y-3">
        ...
        <p className="text-sm text-slate-600">
          Section bibliothèque de l&apos;utilisateur : contenus accessibles grâce à
          un abonnement ou un achat PPV. Pour le MVP, nous affichons une autre
          sélection du flux.
        </p>
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {purchased.map((item) => (
