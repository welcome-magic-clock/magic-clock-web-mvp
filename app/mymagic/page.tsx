...
async function getPublishedMagicClocks(
...
export default async function Page() {
  ...
  // Non connecté → page de connexion dédiée (propre, pas de popup)
  if (!user) {
    redirect("/auth?next=/mymagic");
  }

  const published = await getPublishedMagicClocks(user.email ?? "");
