...
export default function MagicDisplayClient() {
  ...
  // 👉 mémorise sur QUELLE FACE on ouvre le picker
  ...
  async function handleMediaFileChange(
    ...
    // 2) Fichiers (PDF, etc.) → pas de compression, upload direct non géré ici
    //    On garde le blob local comme fallback pour les fichiers
    if (type === "file") {
    ...
    // 3) Compression + upload R2 en arrière-plan (photo & vidéo)
    try {
