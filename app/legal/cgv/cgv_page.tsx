...
// PostFinance eCom et Adyen retirés
      ...
      <div className="space-y-8 text-sm leading-relaxed text-slate-700">
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            individuelle de droit suisse, dont le siège social est situé à{" "}
            <strong>Rue des Saars 6, 2000 Neuchâtel – Suisse</strong>{" "}
            (ci-après l'<strong>« Éditeur »</strong>,{" "}
            <strong>« nous »</strong>).
          </p>
          <p className="mt-2">
            En accédant à la Plateforme, en créant un compte ou en achetant
            un contenu ou un abonnement, l'utilisateur (ci-après{" "}
        ...
        <section>
          ...
          <ul className="mt-2 list-disc space-y-1 pl-5">
            ...
            <li>
              <strong>Contenu</strong> : tout élément publié par un
              Utilisateur via la Plateforme (images, vidéos, textes,
              commentaires, profils, etc.).
            </li>
            <li>
              <strong>Abonnement</strong> : formule payante permettant
              d'accéder à certains contenus d'un Créateur pour une période
              déterminée.
            </li>
            <li>
              <strong>Contenu PPV (« Pay-Per-View »)</strong> : contenu
              payant accessible après achat unitaire.
            </li>
            <li>
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            dans l'Union européenne / EEE, au Royaume-Uni, aux États-Unis et,
          ...
          <p className="mt-2">
            ...
            résidence habituelle de l'Utilisateur et les présentes CGU/CGV,
            les règles impératives locales prévalent.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-1">
            ...
            à jour, à ne pas usurper l'identité d'un tiers et à garder vos
          ...
          <ul className="mt-1 list-disc space-y-1 pl-5">
            ...
            <li>
              comportement illicite, trompeur, haineux ou abusif ;
            </li>
          ...
          <p className="mt-1">
            Nous pouvons mettre en place, lorsque cela est requis ou
            approprié, des mécanismes de{" "}
            <strong>vérification d&apos;âge</strong> ou demander des
            informations complémentaires afin de nous assurer que
            l&apos;Utilisateur remplit les conditions d&apos;âge minimum.
          </p>
          <p className="mt-1">
            Il est interdit de créer un compte pour le compte d&apos;un mineur
            sans l&apos;autorisation requise d&apos;un représentant légal ou
            en fournissant des informations fausses. Tout compte créé en
            violation de cette règle pourra être suspendu ou fermé.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            des créateurs indépendants de publier, monétiser et partager leurs
        ...
        <section>
          ...
          <ul className="mt-1 list-disc space-y-1 pl-5">
            ...
            <li>
              le contenu ne viole aucun droit de tiers ni aucune loi
              applicable ;
            </li>
            <li>
          ...
          <p className="mt-1">
            ...
            droits, une{" "}
            <strong>
              licence non exclusive, transférable, sous-licenciable et
              gratuite
            </strong>{" "}
            afin de :
          </p>
          ...
          <p className="mt-1">
            Vous pouvez supprimer vos contenus à tout moment. Certains
            contenus peuvent cependant être conservés en raison d'obligations
            légales ou pour la gestion de litiges.
          </p>
          <h3 className="mt-3 font-medium text-slate-900">
          ...
          <p className="mt-1">
            ...
            d&apos;expérience</strong>. L&apos;acquisition d&apos;un contenu
            ne comporte aucune promesse de résultat garanti.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="mt-2 list-disc space-y-1 pl-5">
            <li>
              violents, haineux, discriminatoires, diffamatoires,
              harcelants ou pornographiques ;
            </li>
            <li>
              portant atteinte à la dignité humaine, aux mineurs, ou
              incitant à des activités illégales ;
            </li>
            <li>
              portant atteinte aux droits de propriété intellectuelle ou
              aux données personnelles de tiers ;
            </li>
            <li>
              relevant de la fraude, de la manipulation de paiements ou
              de statistiques ;
            </li>
            <li>
        ...
        <section>
          ...
          <p className="mt-1">
            Les Créateurs fixent librement le prix de leurs abonnements et
            de leurs contenus PPV, dans les limites techniques définies par
            la Plateforme (de 0,99 à 999,99 dans la devise d&apos;achat).
          </p>
          <h3 className="mt-3 font-medium text-slate-900">
            8.2. Commission de la Plateforme
          </h3>
          <p className="mt-1">
            L'Éditeur perçoit une <strong>commission de 20 % à 30 %</strong>{" "}
            selon la catégorie du Créateur, indiquée dans l'interface
            Monétisation.
          </p>
          <h3 className="mt-3 font-medium text-slate-900">
            8.3. Taxes et TVA
          ...
          <p className="mt-1">
            Les prix affichés sont, lorsque la loi l'exige, indiqués TTC dans
            la devise d&apos;achat de l&apos;Utilisateur.
          </p>
          <h3 className="mt-3 font-medium text-slate-900">
          ...
          <p className="mt-1">
            ...
            de services de paiement tiers. En utilisant les Services payants,
            vous acceptez également les conditions générales de Stripe.
          </p>
          <h3 className="mt-3 font-medium text-slate-900">
            8.5. Droit de rétractation
          </h3>
          <p className="mt-1">
            Pour les consommateurs résidant dans l'UE/EEE ou au Royaume-Uni,
            le droit de rétractation peut être limité pour les contenus
            numériques fournis immédiatement après l'achat, lorsque
            l'Utilisateur a expressément consenti à l'exécution immédiate.
          </p>
        </section>

        {/* 8 bis. Moyens de paiement */}
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            encaissées, déduction faite de la commission de la Plateforme,
            des taxes applicables et des frais de paiement.
          </p>
          <h3 className="mt-3 font-medium text-slate-900">
          ...
          <p className="mt-1">
            ...
            déclarations fiscales et sociales liées aux revenus perçus via
            Magic Clock.
          </p>
          <h3 className="mt-3 font-medium text-slate-900">
            9.2. Versements
          ...
          <p className="mt-1">
            Les revenus sont versés en principe autour du{" "}
            <strong>15 de chaque mois</strong> pour les ventes du mois
            précédent. Un seuil minimum de versement de{" "}
            <strong>50 CHF / EUR</strong> peut s&apos;appliquer.
          </p>
          <h3 className="mt-3 font-medium text-slate-900">
            9.3. Blocage préventif et litiges
          </h3>
          <p className="mt-1">
            En cas de suspicion raisonnable de fraude ou de non-respect grave
            des CGU/CGV, nous pouvons bloquer temporairement les sommes dues,
        ...
        <section>
          ...
          <p className="mt-2">
            Les Utilisateurs peuvent signaler un contenu ou un comportement
            via les outils prévus à cet effet. Nous pouvons retirer ou
            restreindre l'accès à un contenu, limiter certaines
            fonctionnalités ou fermer un compte.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            designs, textes, code, fonctionnalités, etc.) sont protégés par
            des droits de propriété intellectuelle. Sauf autorisation écrite
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            ne garantit pas la disponibilité ininterrompue des Services, et
            ne peut être tenu responsable des dommages indirects ou pertes de
            données.
          </p>
        </section>
