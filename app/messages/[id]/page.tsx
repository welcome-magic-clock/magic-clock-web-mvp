...
export default function MessageThreadPage({
  ...
  return (
    <main className="mx-auto flex min-h-[calc(100vh-72px)] max-w-3xl flex-col px-4 pb-6 pt-4 sm:px-6 lg:px-8">
      {/* Header simple */}
      ...
      {/* Zone messages (lecture seule pour l’instant) */}
      <section className="flex-1 rounded-3xl border border-slate-200 bg-white/80 p-3 sm:p-4">
