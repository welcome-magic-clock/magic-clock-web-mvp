...
// ✅ v4.2 — 11 réseaux sociaux avec logos depuis GitHub public
"use client";
...
// Base URL logos GitHub public
const GH =
  "https://raw.githubusercontent.com/welcome-magic-clock/magic-clock-web-mvp/main/public/";

// Réseaux sociaux — 11 plateformes avec logos depuis GitHub
const SOCIAL_NETWORKS = [
  ...
  { id: "pinterest", label: "Pinterest",    icon: `${GH}magic-clock-social-pinterest.png`,  followers: 2800  },
  { id: "threads",   label: "Threads",      icon: `${GH}magic-clock-social-threads.png`,    followers: 1900  },
  { id: "twitch",    label: "Twitch",       icon: `${GH}magic-clock-social-twitch.png`,     followers: 3100  },
  { id: "bereal",    label: "BeReal",       icon: `${GH}magic-clock-social-bereal.png`,     followers: 950   },
];
...
function PayoutsSection({
  ...
  const kycBorderClass = "border-amber-200 bg-amber-50 text-amber-700";
  const kycLabel = "KYC en cours…";
  ...
  return (
    <section className="space-y-4 rounded-2xl border border-slate-200 bg-white/80 p-4 shadow-sm">
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <div
          className={`inline-flex items-center gap-1.5 rounded-full border px-2.5 py-1 text-[11px] font-medium ${kycBorderClass}`}
        >
          ...
          <div className="flex items-center gap-2 rounded-xl border border-indigo-100 bg-indigo-50/60 px-3 py-2.5">
            ...
            <div>
              ...
              <p className="text-[10px] text-indigo-500">
                Dernier versement :{" "}
                <strong>{formatMoney(lastPayoutAmount, currency)}</strong> le 15
                mars 2026
              </p>
            </div>
          </div>
...
export function RealMonetPanel({ creator }: RealMonetPanelProps) {
  ...
  const realDailyRevenue: DailyRevenuePoint[] = useMemo(() => {
    ...
    return Array.from({ length: days }, (_, index) => {
      ...
      const wavePpv = 0.2 * Math.sin(index / 1.7) + 0.05 * Math.cos(index / 4);
    ...
    <div className="space-y-4">
      ...
      <section className="space-y-4 rounded-2xl border border-slate-200 bg-white/80 p-4 shadow-sm">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <p className="text-[11px] text-slate-500">
            Montants TTC, TVA estimée, base HT pour répartition plateforme /
            créateur.
          </p>
        </div>
        ...
        >
          <div className="mb-3 flex flex-col gap-1 text-[11px] md:flex-row md:items-center md:justify-between">
            ...
            <p className="text-slate-500">
              Répartition sur 30 jours, basé sur tes chiffres PPV /
              abonnements.
            </p>
          </div>
          <div className="mt-1">
        ...
        <div className="mt-3 grid gap-4 md:grid-cols-3">
          ...
          >
            ...
            <div className="mt-1 flex items-center justify-between gap-3">
              <div className="flex items-center gap-2">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-[11px] text-slate-500">
                    Followers réels sur Magic Clock.
                  </p>
                </div>
              </div>
            ...
            {/* Réseaux sociaux — 11 logos depuis GitHub */}
            <div className="mt-3 rounded-xl border border-slate-200 bg-white/80 px-3 py-2">
              ...
              <p className="mt-3 text-[10px] leading-snug text-slate-500">
                Chiffres indicatifs MVP. En production, synchronisés via APIs
                officielles.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <p className="mt-1 text-[11px] text-slate-500">
              Revenu brut Abo :{" "}
              {formatMoneyCompact(realGrossAbos, currency)} / mois (TTC).
            </p>
            <div className="mt-2">
          ...
          >
            ...
            <p className="mt-1 text-[11px] text-slate-500">
              Revenu brut PPV :{" "}
              {formatMoneyCompact(realGrossPpv, currency)} / mois (TTC).
            </p>
              ...
              <div className="mt-3 grid gap-3 text-xs md:grid-cols-2">
                <div className="rounded-lg border border-slate-200 bg-white/80 p-3">
                  ...
                  <p className="mt-1 text-[11px] text-slate-500">
                    ...
                    {Math.round(realPriceTier.platformRate * 100)}% · inclut frais
                    Adyen.
                  </p>
                </div>
                <div className="rounded-lg border border-emerald-100 bg-emerald-50/60 p-3">
                  ...
                  <p className="mt-1 text-[11px] text-emerald-600/80">
                    {Math.round(realPriceTier.creatorRate * 100)}% de la base HT —
                    versé le 15 du mois.
                  </p>
                </div>
              </div>
          ...
          <div className="space-y-3 rounded-xl border border-slate-200 bg-slate-50/80 p-4">
            ...
            <div className="mt-1 rounded-lg border border-slate-100 bg-white/60 p-2">
              ...
              <p className="mt-1.5 text-[10px] text-slate-400">
                Plus ton contenu est cher → plus tu gardes. Modèle tout compris,
                sans frais cachés.
              </p>
            </div>
          </div>
