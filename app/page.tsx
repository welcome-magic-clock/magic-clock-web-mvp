...
function AmazingContent() {
  ...
  useEffect(() => {
    // Cas 1 : URL explicite ?auth=required
    if (searchParams.get("auth") === "required") {
      setShowAuth(true);
      return;
    }

    // Cas 2 : Visiteur non connecté → ouvrir la modal automatiquement
  ...
  return (
    <main className="mx-auto max-w-5xl px-4 pb-24 pt-4 sm:px-6 sm:pt-8 sm:pb-28">
      ...
      {/* AuthModal — s'ouvre si visiteur non connecté OU si ?auth=required */}
      <AuthModal
        isOpen={showAuth}
