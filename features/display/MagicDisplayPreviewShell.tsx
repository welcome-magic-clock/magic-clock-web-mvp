                      ...
                      {(() => {
                        ...
                        return facesForCube.map((face, index) => {
                          ...
                          return (
                            ...
                            >
                              {/* FACE AVANT : ✅ CubeFaceMedia remplace <img> brut */}
                              <div className="absolute inset-0 overflow-hidden rounded-none border border-slate-900/10 bg-slate-900/95 text-xs shadow-xl shadow-slate-900/40 [backface-visibility:hidden]">
                                {imgUrl ? (
                                  // ✅ MODIFIÉ — lazy load + zéro autoPlay vidéo
                                  <CubeFaceMedia
                                    src={imgUrl}
                                    kind={
                                      mergedFace.coverMedia?.type === "video"
                                        ? "video"
                                        : "photo"
                                    }
                                    alt={label}
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-slate-200 bg-slate-50">
                        <div className="relative mx-auto aspect-[4/5] w-full max-w-xl">
                          <div className="grid h-full w-full grid-cols-2">
                            ...
                            {/* Après = segment opposé — ✅ LazyMediaSlot */}
                            <div className="relative h-full w-full">
                      ...
                      <div className="relative overflow-hidden rounded-2xl border border-slate-200 bg-slate-50">
                        <div className="relative mx-auto aspect-[4/5] w-full max-w-xl">
                          {(() => {
                            ...
                            // ✅ MODIFIÉ — LazyMediaSlot pour photo ET vidéo
                            return (
                              <LazyMediaSlot
                                src={url}
                                kind={type}
