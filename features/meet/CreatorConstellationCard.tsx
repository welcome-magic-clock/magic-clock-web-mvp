...
function FeaturedCard({ creator, onOpen }: Props) {
  return (
    <div className="cursor-pointer" style={{ borderRadius: 24, boxShadow: "0 0 0 2px white, 0 0 0 3px #7B4BF5, 0 4px 20px rgba(123,75,245,.25)" }} onClick={onOpen}>
...
export function CreatorConstellationCard({ creator, featured, isMet, onOpen, onMeet }: Props) {
  ...
  return (
    <div className={`${rc} cursor-pointer`} onClick={onOpen}>
